...
group by user_id;
~~~
### [1661. Average Time of Process per Machine](https://leetcode.com/problems/average-time-of-process-per-machine/description/?envType=problem-list-v2&envId=database)
~~~SQL
SELECT 
    a1.machine_id,
